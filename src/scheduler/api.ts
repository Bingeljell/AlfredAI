...
export interface SchedulerTaskApi {
  ...
  complete(taskId: string, cycleId: string, nextDueAt?: string, observationDigest?: string, completionSummary?: string, observationStatus?: NonNullable<ScheduledTaskV1["lastObservationStatus"]>): Promise<ScheduledTaskV1>;
